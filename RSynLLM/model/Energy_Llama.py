...
IGNORE_INDEX = -100
DEFAULT_STHIS_TOKEN = "<ME_HIS>"
DEFAULT_STPRE_TOKEN = "<ME_PRE>"
DEFAULT_ST_PATCH_TOKEN = "<ME_patch>"
DEFAULT_ST_START_TOKEN = "<ME_start>"
DEFAULT_ST_END_TOKEN = "<ME_end>"
...
class STLlamaModel(LlamaModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        if hasattr(config, "st_tower"):
            if self.config.st_tower == "MoE_Encoder":
                args = parse_args()
...
class STLlamaForCausalLM(LlamaForCausalLM):
    ...
    def __init__(self, config):
        ...
        #     nn.Linear(self.config.lin_hidden_size*2, self.config.lin_hidden_size*2),
        #     nn.GELU(),
        #     nn.Linear(self.config.lin_hidden_size*2, self.config.lin_hidden_size*2),
        # )
